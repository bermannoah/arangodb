Gem::Specification.new do |s|
  s.name        = "arangodb"
  s.version     = "1.0.0"
  s.summary     = "Do not use this! This could be a malicious gem because you didn't check if the code ChatGPT wrote for you referenced a real gem or not. Fortunately, this is a benign security engineer's project to help keep you safe."
  s.description = "A ChatGPT honeypot :("
  s.authors     = ["Noah Berman"]
  s.email       = "noah@noahberman.org"
  s.files       = ["lib/arangodb.rb"]
  s.homepage    =
    "https://rubygems.org/gems/arangodb"
  s.license       = "MIT"
